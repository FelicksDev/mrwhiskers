...
<body>
  ...
  <div class="d-flex align-items-center justify-content-center"  style="height: 100vh;">
      <div class="col-md-3">
        <div class="card">
          <div class="card-header bg-primary text-white text-center fw-bold">Inicio de sesión - Sistema</div>
          <div class="card-body"> 
            
            <form action="{{route('admin.PostLogin')}} " method="POST" class="row g-3 needs-validation" novalidate >
            ...
            <div class="text-center">
              ¿No tienes una cuenta? <a href="{{route('admin.GetRegister')}}">Regístrate aquí</a>
            </div>
            </form>
          </div>
        </div>
